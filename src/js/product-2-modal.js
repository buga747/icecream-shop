(() => {
  const refs = {
    openModalBtn: document.getElementById('product-modal-2-open'),
    closeModalBtn: document.getElementById('products-modal-2-close'),
    modal: document.getElementById('product-modal-2'),
  };
