(() => {
  const refs = {
    openModalBtn: document.getElementById('product-modal-1-open'),
    closeModalBtn: document.getElementById('products-modal-1-close'),
    modal: document.getElementById('product-modal-1'),
  };
